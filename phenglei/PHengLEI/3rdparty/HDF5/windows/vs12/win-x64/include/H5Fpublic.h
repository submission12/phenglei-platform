...
H5_DLL ssize_t_h5 H5Fget_obj_count(hid_t file_id, unsigned types);
H5_DLL ssize_t_h5 H5Fget_obj_ids(hid_t file_id, unsigned types, size_t max_objs, hid_t *obj_id_list);
...
H5_DLL ssize_t_h5 H5Fget_name(hid_t obj_id, char *name, size_t size);
