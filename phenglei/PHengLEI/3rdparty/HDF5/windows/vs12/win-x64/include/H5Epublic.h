...
H5_DLL ssize_t_h5 H5Eget_class_name(hid_t class_id, char *name, size_t size);
...
H5_DLL ssize_t_h5 H5Eget_msg(hid_t msg_id, H5E_type_t *type, char *msg,
    size_t size);
H5_DLL ssize_t_h5 H5Eget_num(hid_t error_stack_id);
