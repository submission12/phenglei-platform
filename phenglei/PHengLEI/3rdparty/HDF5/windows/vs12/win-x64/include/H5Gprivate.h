...
H5_DLL ssize_t_h5 H5G_get_name(const H5G_loc_t *loc, char *name/*out*/, size_t size,
    hbool_t *cached, hid_t lapl_id, hid_t dxpl_id);
H5_DLL ssize_t_h5 H5G_get_name_by_addr(hid_t fid, hid_t lapl_id, hid_t dxpl_id,
...
H5_DLL ssize_t_h5 H5G_loc_get_comment(H5G_loc_t *loc, const char *name,
