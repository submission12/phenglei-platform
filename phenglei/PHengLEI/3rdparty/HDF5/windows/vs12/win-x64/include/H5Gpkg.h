...
H5_DLL ssize_t_h5 H5G_stab_get_name_by_idx(H5O_loc_t *oloc, H5_iter_order_t order,
...
H5_DLL herr_t H5G_compact_insert(const H5O_loc_t *grp_oloc, H5O_link_t *obj_lnk,
    hid_t dxpl_id);
H5_DLL ssize_t_h5 H5G_compact_get_name_by_idx(H5O_loc_t *oloc, hid_t dxpl_id,
...
H5_DLL ssize_t_h5 H5G_dense_get_name_by_idx(H5F_t  *f, hid_t dxpl_id,
...
H5_DLL ssize_t_h5 H5G_obj_get_name_by_idx(H5O_loc_t *oloc, H5_index_t idx_type,
