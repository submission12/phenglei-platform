...
typedef ssize_t_h5 (*H5T_vlen_getlenfunc_t)(const void *vl_addr);
...
H5_DLL herr_t H5T_bit_shift(uint8_t *buf, ssize_t_h5 shift_dist, size_t offset, size_t size);
...
H5_DLL void H5T_bit_set_d(uint8_t *buf, size_t offset, size_t size,
			   uint64_t val);
H5_DLL ssize_t_h5 H5T_bit_find(uint8_t *buf, size_t offset, size_t size,
