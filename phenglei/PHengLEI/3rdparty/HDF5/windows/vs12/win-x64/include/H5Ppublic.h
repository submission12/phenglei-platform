...
H5_DLL ssize_t_h5 H5Pget_data_transform(hid_t plist_id, char* expression /*out*/, size_t size);
...
H5_DLL ssize_t_h5 H5Pget_elink_prefix(hid_t plist_id, char *prefix, size_t size);
